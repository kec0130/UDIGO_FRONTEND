# 이미지 분류 AI를 활용한 장소 검색 서비스 - UDIGO
...
이 프로젝트는 AI 부트캠프를 통해 처음으로 개발을 배우게 된 2021년, 제가 기획한 아이디어로 5명의 팀원과 함께 안드로이드 앱으로 출시했던 프로젝트입니다. 당시 기획과 AI 모델링을 담당하면서 제 아이디어를 서비스로 직접 구현해보고 싶은 갈망이 생겨 프론트엔드 개발자의 길을 걷게 되었습니다. 그 때의 초심을 잃지 않기 위해 앱의 기능을 간소화하여 간단한 웹 서비스로 구현해보았습니다.
...
### 이미지 최적화
- 페이지를 빠르게 로딩하기 위해 이미지 사이즈를 모두 100KB 내외로 줄여서 사용했습니다.
